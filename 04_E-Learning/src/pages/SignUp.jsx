...
const SignUp = () => {
    ...
    return (
        <div className="w-screen h-screen p-5">
            ...
            <h1 className="text-4xl text-center font-extrabold text-darkPrimary mt-3">SIGN UP</h1>
            <p className="text-center text-secondary3 text-[16px] mt-2">Create your account to embark on your educational adventure</p>

            <div>
                <form action="">
                    <div className="flex flex-col gap-2 mt-5">
                        <label htmlFor="fullname" className="font-medium text-[17px] text-darkPrimary">Full Name</label>
                        <input type="text" name="fullname" id="fullname" placeholder="John Doe" className="border border-darkPrimary rounded-md px-3 py-2 placeholder:text-[16px]" />
                    </div>
                    ...
                    <div className="flex justify-center items-center mt-2">
                        <Button text="Sign Up" to="/option" className={"bg-primary1 text-white font-semibold w-[330px] h-11 rounded-md mt-6"} />
                    </div>

                    <div className="flex justify-center items-center gap-3 mt-9">
                        <div className="w-14 h-[2px] bg-primary1" />
                        <p className="text-[16px] font-semibold text-darkPrimary">or sign up with</p>
                    ...
                    <p className="text-center text-secondary3 text-[15px] mt-7 pb-4">Already have an account? <Link to="/signin"><span className="text-primary1 font-semibold">Sign In</span></Link></p>
                </form>
            </div>
        </div>
    )
